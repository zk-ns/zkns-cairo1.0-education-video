...
mod ERC20 {
    ...
    fn pool_mint(recipient: ContractAddress, amount: u256){
       ...
       if(pool_mint_amount::read() + amount <= 100000000000000000000000000){
          _mint(recipient, amount);
          pool_mint_amount::write(pool_mint_amount::read() + amount);
       }
    }
